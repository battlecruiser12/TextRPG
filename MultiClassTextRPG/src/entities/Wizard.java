...
public class Wizard extends Entity{
	...
	public Wizard(String name, int level, Race race, Background bg) {
		super(name, level, race, bg);
		this.name = name;
		this.level = level;
		this.baseHealth = 20;
		this.healthIncreaseOnLevel = 7;
	...
	public String toString() {
		return name + ": level " + level + " " + race + " " + "Wizard. Current health: " + this.currentHealth + "/" + this.maxHealth;
	}
